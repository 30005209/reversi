...
pkgdatadir = $(datadir)/reversi
pkgincludedir = $(includedir)/reversi
pkglibdir = $(libdir)/reversi
pkglibexecdir = $(libexecdir)/reversi
...
PACKAGE = reversi
PACKAGE_BUGREPORT = 
PACKAGE_NAME = reversi
PACKAGE_STRING = reversi 1.0
PACKAGE_TARNAME = reversi
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
